...
barplot(ego_high_log, showCategory = 15, title = "Barplot for TERT-high log genes")
barplot(ego_low_log, showCategory = 15, title = "Barplot for TERT-low log genes")
...
barplot(ego_PC1_pos, showCategory = 15, title = "GO analysis of genes giving positive weight to PC1")
barplot(ego_PC1_neg, showCategory = 15, title = "GO analysis of genes giving negative weight to PC1")
