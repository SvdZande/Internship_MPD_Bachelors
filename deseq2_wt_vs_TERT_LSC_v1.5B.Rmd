...
pdf(paste(resultsdir,'GO_LSC_splice.pdf',sep="/") ,width=20,height=9,paper='special')
...
pdf(paste(resultsdir,'GO_LSC_splice_exp.v2.pdf',sep="/") ,width=20,height=9,paper='special')
splice_diff_pos_GO <- barplot(ego_diff_pos, showCategory = 15, title = "Genes that are differentially spliced and upregulated")
splice_diff_neg_GO <- barplot(ego_diff_neg, showCategory = 15, title = "Genes that are differentially spliced and downregulated")
