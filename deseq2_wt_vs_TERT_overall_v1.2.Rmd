...
PCA_pos_ALL <- barplot(ego_PC1_pos, showCategory = 15, title = "Processes giving positive weight to PC1")
PCA_neg_ALL <- barplot(ego_PC1_neg, showCategory = 15, title = "Processes giving negative weight to PC1")
PCA_pos_ALL
PCA_neg_ALL
